	...
	return (
		<Dialog open={props.open} onOpenChange={props.setOpen}>
			<DialogContent
				...
				<DialogTitle className="text-2xl">Hey...</DialogTitle>
				...
				<Button onClick={reframeLater} className="bg-mutedorange hover:bg-mutedorange hover:brightness-90 text-white">ok.</Button>
			</DialogContent>
		</Dialog>
	)
}
